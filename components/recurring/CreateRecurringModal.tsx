...
export function CreateRecurringModal({ isOpen, onClose, onCreate }: CreateRecurringModalProps) {
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
            ...
            >
              ...
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-white">New Recurring Payment</h2>
                <button
                  onClick={onClose}
